...
CREATE TABLE `answer` (
  ...
  `more` varchar(255) DEFAULT NULL COMMENT '备注内容(当选项为"其他"时填写该字段)',
  PRIMARY KEY (`id`)
...
CREATE TABLE `question_type` (
  ...
  `delete_time` int(11) NOT NULL DEFAULT '0' COMMENT '删除时间(时间戳)',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='题型表';

#
# Data for table "question_type"
#

INSERT INTO `question_type` VALUES (1,'单选题',0),(2,'多选题',0),(3,'描述题',0);
...
INSERT INTO `questionnaire` VALUES (1,'购房需求调查问卷',1,1,1551686187,0,0,0);
